# Informatique et Intelligence Artificielle — Guide du cours (IIA2106)
...
- Domaine : Sciences de la santé — Mention : Médecine
- Intitulé / code UE : Informatique et Intelligence Artificielle (IIA2106)
- Crédits : 2 ECTS
- Volume horaire : 50 h (CT 20 h, TD/TP 10 h, TPE 20 h)
- Compétence cœur : C5.2 Utiliser les TIC pour diffuser des résultats de recherche en français et en anglais
- Objectif général : acquérir les bases en informatique et IA nécessaires à la réalisation et à la communication d'activités de recherche.
...
- Décrire les concepts fondamentaux de l'informatique et de l'IA et leurs applications biomédicales.
- Traiter et analyser des données scientifiques avec Python, Pandas, PyTorch.
- Évaluer de façon critique l'usage de l'IA en médecine, y compris les enjeux éthiques.
...
## Modalités pratiques
- Chaque notebook fournit objectifs, contexte médical, code commenté et exercices.
- Les séances alternent cours magistral (CT), travaux dirigés/pratiques (TD/TP) et TPE orientés projet.
- Les notions de surapprentissage et sous-apprentissage sont introduites tôt pour guider la validation des modèles.
...
- Évaluations formatives dans les notebooks (exercices, mini-projets courts).
- Projet final : étude de cas clinique, implémentation d'un modèle et analyse critique incluant les aspects éthiques et cliniques.